...
var myOptions = {
	...
	if(jQuery('input[name="_tbwshow_slider"]:checked').val() == 'yes' || jQuery('input[name="_tbwshow_slider"]:checked').val() == '') {
		jQuery('#banner_details').slideUp();
	}

	jQuery('input[name="_tbwshow_slider"]').click(function() {
		if(jQuery('input[name="_tbwshow_slider"]:checked').val() == 'yes' || jQuery('input[name="_tbwshow_slider"]:checked').val() == '') {
			jQuery('#banner_details').slideUp();
		}
		else {
			jQuery('#banner_details').slideDown();
		}	
	});
