...
<main>
    <div class="container">
        <div class="wrap">
            <div class="row">
                <div class="col-md-4">
                    <h1 class="page-header">create reorder</h1>
                </div>
                <div class="col-md-8">
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">step 1: select order</h3>
                        </div>
                                    ...
                                    {% for customerOrder in customerOrders  %}
                                        <tr>
                                           ...
                                           <td></td>
                                            ...
                                            <td><a href="{{httpBasePath}}create-reorder2/{{customerOrder['order_id']}}">Re Order</a></td>
                                        </tr>
